...
class DealAgentFramework:
    ...
    def __init__(self):
        ...
        try:
            ...
            logging.info(f"Falling back to in-memory Chroma client: {e}")
    ...
    def get_plot_data(cls, max_datapoints=2000):
        ...
        try:
            ...
            categories = [metadata.get("category", CATEGORIES[0]) for metadata in metadatas]
            colors = [COLORS[CATEGORIES.index(c)] if c in CATEGORIES else COLORS[0] for c in categories]
            if len(vectors) < 2:
