...
class FrontierAgent(Agent):
    ...
    def __init__(self, collection):
        ...
        self.log(f"Frontier Agent is set to use {self.model_name} via LiteLLM")
    ...
    def find_similars(self, description: str):
        ...
        try:
            ...
            self.log(f"Frontier Agent could not query vector DB; continuing with no context: {e}")
            return [], []
    ...
    def price(self, description: str) -> float:
        ...
        self.log(
            f"Frontier Agent is about to call {self.model_name} with context including 5 similar products"
        )
        try:
            ...
            self.log(f"Frontier Agent failed - returning $0.00: {e}")
            return 0.0
